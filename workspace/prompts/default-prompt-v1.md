...
## ðŸ§  **Product Viability Analysis Prompt v9 **
...
Given a concept document or idea, evaluate it across *strategic, technical, and operational viability dimensions* â€“ emphasizing **feasibility using AI/low-code tools, market defensibility, ROI potential, and MVP readiness**.
...
### ðŸ”§ **Default Assumptions & Parameters**
...
**PRECISION ANALYSIS PHASES (Temperature = 0.2):**
...
### ðŸ§© **Report Structure: 9-Tab Interactive Analysis**
...
### ðŸ“Š **Detailed Tab Requirements**

#### **Tab 2: Market Landscape Deep Dive**
- **Existing Solutions Analysis:** List 3-5 comparable products with:
  - Technical stack and capabilities
  - Target audience and pricing model
  - Market positioning and adoption stage
  - Key strengths and limitations
- **Competitive Comparison Table:** Score competitors (1-10) across dimensions like automation, UX, integrations, domain focus
- **Market Timing Rationale:** Why now? (AI readiness, regulatory changes, user behavior shifts, technology inflection points)
- **White Space Identification:** Clear gaps and unmet needs in current market

#### **Tab 3: Technical Feasibility Focus**
- **AI/Low-Code Architecture:** Leverage existing APIs, AI models, automation platforms
- **Implementation Complexity:** Assessment of development effort using modern tools
- **Scalability Considerations:** Performance, data handling, user growth capacity
- **Technology Risk Assessment:** Dependencies, API limitations, platform risks

#### **Tab 4: Competitive Defensibility Analysis**
- **Competitive Scoring Matrix:** Rate top 3-5 competitors across key dimensions
- **Differentiation Factors:** Unique positioning and competitive advantages
- **Moat Analysis:** 
...
- **Long-term Defensibility:** 12-24 month competitive sustainability

#### **Tab 5: Business Economics & Compliance**
- **Revenue Model & Pricing:** Logic, market benchmarks, expansion pathways
- **Cost Structure & Margins:** Development, operational, customer acquisition costs
- **Financial Projections:** CAC/LTV, unit economics, funding requirements
- **Regulatory & Compliance:** Professional licensing, insurance requirements, legal considerations, security standards

#### **Tab 6: MVP Strategy with Visual Prioritization**
- **Value vs. Effort Matrix Visualization:** Plot features across High/Low Value Ã— High/Low Effort quadrants
- **Phased Roadmap:** 3-4 development phases (Validate â†’ Build â†’ Pilot â†’ Scale)
- **AI/Low-Code Implementation:** Specific tools, platforms, and integration strategies
- **Development Timeline:** Realistic milestones based on complexity assessment

#### **Tab 7: Comprehensive Scoring & Risk Management**
**Viability Scoring (1-10 scale):**
- **Market Validation:** Proven demand, customer willingness to pay, early traction signals
- **Technical Feasibility:** Achievability with AI/low-code tools, implementation complexity
- **Competitive Advantage:** Sustainable differentiation and defensible positioning
- **Business Viability:** Profitability potential, scalability, funding attractiveness
- **Execution Clarity:** Roadmap quality, team readiness, go-to-market plan

**Risk Register:** 3-5 key risks with probability, impact, and mitigation strategies
...
- **Actionable Recommendations:** Concrete steps to address weaknesses
- **Success Criteria:** How to measure improvement progress

#### **Visual Requirements**
- **Value vs. Effort Matrix:** Feature prioritization visualization
- **Competitive Positioning Map:** Market landscape overview
- **Architecture Diagram:** Technical implementation overview (if applicable)
- **Risk-Impact Heatmap:** Visual risk assessment
...
5. **Clear verdict:** âœ… "Go Build", âš™ï¸ "Prototype First", or ðŸ” "Re-validate"

**Target Length:** 1,500-2,000 words total across all tabs
**Style:** McKinsey-like brevity + Founder-deck clarity + Technical precision

### ðŸ“± **HTML Implementation Requirements**
...
### ðŸ“‹ **Success Metrics for Analysis Quality**

- **Completeness:** All 9 tabs with required elements
...
### ðŸ“ **HTML Deliverable Specifications**
...
- Generated via Product Viability Analysis Prompt v6
- Analysis engine and generation date
- Project name and input checksum
- Prompt version (v6.0 / 2025-10)
